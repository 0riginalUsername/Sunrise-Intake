...
from PyQt5.QtGui import QFont, QPalette, QColor, QIcon, QBrush, QPixmap
...
class Config:
    ...
    APP_VERSION = "Data Intake 1.13"
    APP_BUILD_DATE = "03/16/2026"
...
class RinexProcessor:
    ...
    def batch_convert(folder_path: str) -> None:
        ...
        for file_name in t_files:
            try:
                ...
                subprocess.run(command, check=True, timeout=Config.SUBPROCESS_TIMEOUT)
    ...
    def merge_nav_files(nav_files: List[str], output_dir: str) -> Optional[str]:
        ...
        try:
            subprocess.run(cmd, check=True, timeout=Config.SUBPROCESS_TIMEOUT)
...
class ProcessingWorker(QThread):
    ...
    def _cleanup_ppk_folder(self, ppk_folder: str, date_folder: str):
        ...
        if rinex_file:
            ...
            # Skip RTB processing for L3 sensor (processed via DJI Terra instead)
